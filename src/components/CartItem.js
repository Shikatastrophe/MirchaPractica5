...
const CartItem = () => {
    ...
    return <div className="w-2/3 pr-10">
        ...
        <button onClick={()=>dispatch(resetCart())&toast.error("Your cart is now empty")} className="bg-red-500 text-white mt-8 ml-7 py-1 px-6 hover:bg-red-800 duration-300">Reset Cart</button>
        <Link to="/">
